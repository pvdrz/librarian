...
pub trait OrgGnomeShellSearchProvider2 {
    ...
    fn get_subsearch_result_set(&self, previous_results: Vec<&str>, terms: Vec<&str>) -> Result<Vec<String>, tree::MethodErr>;
    fn get_result_metas(&self, identifiers: Vec<&str>) -> Result<Vec<::std::collections::HashMap<String, arg::Variant<Box<dyn arg::RefArg + 'static>>>>, tree::MethodErr>;
    fn activate_result(&self, identifier: &str, terms: Vec<&str>, timestamp: u32) -> Result<(), tree::MethodErr>;
